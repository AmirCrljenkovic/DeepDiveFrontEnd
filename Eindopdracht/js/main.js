...
class Header {
    ...
    constructor(placeToRenderHeader) {
        ...
        this.headerLogo.classList = "fa-regular fa-podcast  header__logo";
...
class Mainrightsection {
    ...
    constructor(mainElement) {
        ...
        this.descriptionIMG.src = "img/thinking.webp";
...
class Footer {
    ...
    constructor(placeToRenderFooter) {
        ...
        this.FooterText.innerText = "Made By -  Amir Crljenkovic";
